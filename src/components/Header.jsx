  ...
  return (
        ...
        <div className="flex justify-between items-center">
            <div className='mr-4'>
                ...
                <div className='flex bg-white h-6 w-90 mx-auto items-center border border-zinc-400'>
                    <div>
                    ...
                    <input
                        className='text-sm text-zinc-600 py-2 px-2 mr-1 h-4 w-60 focus:outline-none'
                        type='text'
                        placeholder='Search...'
                    />
                </div>
