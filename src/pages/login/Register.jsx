    ...
    <div>
        <section className="flex flex-col gap-20 pb-40">
            ...
            className="flex items-start mb-5">
                ...
                <label 
                className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="#" className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a>
                </label>
            </div>
            ...
            <button 
            type="submit" 
            className="pt- text-white bg-blue-400 hover:bg-blue-500 active:bg-blue-700 rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register new account</button>
            </form>
            <div className='flex justify-center items-center'>
                <a href='/login'>
                Login
